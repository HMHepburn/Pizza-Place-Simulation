 ...
 * DrawPizza
 *
 * Date: 17/01/2020 School: Northview Heights Secondary School
 *
 * This class is used to manipulate the graphics and extends class JComponent.
 * This class creates objects that will be displayed as the pizza that the user
 * selected, adding a sense of immersion to the pizza parlour program.
 *
 * @author Nathan Tang and Hannah Hepburn
 * @version 1.0
 */
public class DrawPizza extends JComponent {

    private boolean onion;
    private boolean redPepper;
    ...
    private String cheese; //Mozzarella, cheddar, or none
    private String sauce; //Pesto, cream sauce, tomato, or none
    private String dough; //Whole grain, or regular

    /**
     * Constructor that instantiates a graphics object, to allow program to know
     * what toppings to draw or not
     *
     * @param userPizza
     */
    public DrawPizza(Pizza userPizza) {
        this.onion = userPizza.onion;
        this.redPepper = userPizza.redPepper;
        this.mushroom = userPizza.mushroom;
        this.greenPepper = userPizza.greenPepper;
        this.olive = userPizza.olive;
        this.pineapple = userPizza.pineapple;
        this.tomato = userPizza.tomato;
        this.bacon = userPizza.bacon;
        this.pepperoni = userPizza.pepperoni;
        this.ham = userPizza.ham;
        this.anchovy = userPizza.anchovy;

        this.cheese = userPizza.cheese;
        this.sauce = userPizza.sauce;
        this.dough = userPizza.dough;
    }

    /**
     * paintComponent controls all graphic objects and uses booleans to decide
     * which toppings, dough, sauce, and cheese should be placed on the JFrame
     *
     * @param g
     */
    public void paintComponent(Graphics g) {
        ...
        g2.setColor(new Color(254, 95, 85));
        ...
        //red peppers
        g2.setColor(new Color(255,241,50));
        g2.fillPolygon(new int[] {100, 125, 150}, new int[] {100, 120, 100}, 3);
